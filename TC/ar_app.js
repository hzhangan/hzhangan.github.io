...
var RhinoMesh, RhinoMesh2, RhinoMesh3, RhinoMesh4, RhinoMesh5, RhinoMesh6, RhinoMesh7;
...
function init() {
    ...
    let markerControl = new THREEx.ArMarkerControls(arToolkitContext, markerRoot1, {
        ...
        type: 'pattern', patternUrl: 'data/comida.patt',
    });
    ...
    new THREE.MTLLoader()
        .setPath('data/models/')
        .load('tabla 1.mtl', function (materials) {
            materials.preload();
            new THREE.OBJLoader()
                .setMaterials(materials)
                .setPath('data/models/')
                .load('tabla 1.obj', function (group) {
    ...
    new THREE.MTLLoader()
        .setPath('data/models/')
        .load('salmon 2.mtl', function (materials) {
            materials.preload();
            new THREE.OBJLoader()
                .setMaterials(materials)
                .setPath('data/models/')
                .load('salmon 2.obj', function (group) {
    ...
    new THREE.MTLLoader()
    .setPath('data/models/')
    .load('salmon 3.mtl', function (materials) {
        materials.preload();
        new THREE.OBJLoader()
            .setMaterials(materials)
            .setPath('data/models/')
            .load('salmon 3.obj', function (group) {
    ...
    new THREE.MTLLoader()
        .setPath('data/models/')
        .load('arroz 4.mtl', function (materials) {
            materials.preload();
            new THREE.OBJLoader()
                .setMaterials(materials)
                .setPath('data/models/')
                .load('arroz 4.obj', function (group) {
    ...
    new THREE.MTLLoader()
    .setPath('data/models/')
    .load('arroz 5.mtl', function (materials) {
        materials.preload();
        new THREE.OBJLoader()
            .setMaterials(materials)
            .setPath('data/models/')
            .load('arroz 5.obj', function (group) {
        ...
        new THREE.MTLLoader()
        .setPath('data/models/')
        .load('alga 6.mtl', function (materials) {
            materials.preload();
            new THREE.OBJLoader()
                .setMaterials(materials)
                .setPath('data/models/')
                .load('alga 6.obj', function (group) {
    ...
    new THREE.MTLLoader()
    .setPath('data/models/')
    .load('palta 7.mtl', function (materials) {
        materials.preload();
        new THREE.OBJLoader()
            .setMaterials(materials)
            .setPath('data/models/')
            .load('palta 7.obj', function (group) {
